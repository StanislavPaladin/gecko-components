	...
	return (
		<>
			...
			<InputComponent
				...
				// new props to customize label colors
				isColoredWord={true}
				wordToColor={"Bitcoin"}
				wordColor={"#509772"}
			/>
			...
			<div className="walletDeposit-body-notice">
				<span>Notice: </span> Send only BTC to this address. Coins wil
				be deposited after 2 network confirmations
			</div>
		</>
	);
};
	...
	return (
		<React.Fragment>
			<ButtonsNavigation
				buttonsList={[
					{ text: "Swap" },
					{ text: "From altcoin", active: true },
				]}
				backgroundColor="#262B3D"
				activeColor="#3D4459"
			/>
			<div className="walletDeposit-body-message">
				<span>From Altcoin: </span> Deposit using any ERC altcoins. Your
				funds will be convertered and credited in the chosen currency
				supported by GAMEDEFI. Currentlyt only alt coins on ERC chain
				are supported
			</div>
			<SelectComponent
	...
	return (
		<div>			
			...
			<div className="sequrityOptions-download">
				...
				Two-factor Autentification to protect your account from
				unauthorized access.
			</div>
			<p className="sequrityOptions-text">
				Scan the QR-code with your Google Autenticator App or enter the
				secret key manually.
			</p>
			...
			/>
			<p className="sequrityOptions-text">
				Write down this code, never reveral it to others. You can use it
		...
		<div className="layout">
			<div className="walletDeposit">
				...
				<div className="walletDeposit-body">
					<div className="walletDeposit-body-title">Wallet</div>
