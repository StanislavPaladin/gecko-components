...
import { ReactComponent as DiamondImage } from "../../assets/icons/diamond3.svg";
        ...
        {!privacyItem ? (
          <div className="chatModal-body">
            <div className="chatModal-body-head">
              <h3>Chat room</h3>
              <div className="options" onClick={() => setPrivacyActive(true)}>
                <DiamondImage />
                Options
              </div>
            </div>
                ...
                {!activeBtn ? (
                  <div className="friends-list">
                    <div className="friend-request">
                      ...
                      <div className="userText">
                        <p className="title">Friend Request</p>
                        <div className="text">Friend Request Received</div>
                      </div>
                    </div>
                  </div>
                ) : (
                  <div className="chats-list">
                    <div className="chats-list-buttons">
                      ...
                      <div className="chats-list-buttons-btn">Stranger</div>
                    </div>
          ...
          <div className="chatModal-privacy">
            ...
            <PrivacyItem
              ...
              isActive={true}
            />
            <PrivacyItem title={"Refuse tip from strangers"} isActive={false} />
          </div>
        )}
      </div>
    </div>
